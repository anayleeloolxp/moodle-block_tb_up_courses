...
/**
 * Lang strings for tb_up_courses block
 *
...
$string['tb_up_courses:addinstance'] = 'Add a new Leeloo LXP Upcoming Courses block';
$string['tb_up_courses:myaddinstance'] = 'Add a new Leeloo LXP Upcoming Courses block to Dashboard';
$string['defaultmaxcourses'] = 'Default maximum courses';
$string['defaultmaxcoursesdesc'] = 'Maximum courses which should be displayed on Leeloo LXP Upcoming Courses block, 0 will show all courses';
...
$string['pluginname'] = 'Leeloo LXP Upcoming Courses';
$string['displayname'] = 'Leeloo LXP Upcoming Courses';
...
$string['tb_up_courses_bgimage'] = "Embed images into background";
$string['tb_up_courses_bgimage_desc'] = "This will embed images into background as a CSS property";
...
$string['privacy:metadata'] = 'The Leeloo LXP Upcoming Courses (tb_up_courses) block only shows information about courses and does not store data itself.';

$string['blocktitle'] = 'Leeloo LXP UpComing Courses';
